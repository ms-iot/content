...
including [SSH]({{site.baseurl}}/{{page.lang}}/Docs/SSH.htm), [Powershell]({{site.baseurl}}/{{page.lang}}/Docs/PowerShell.htm), [Windows Device Portal]({{site.baseurl}}/{{page.lang}}/Docs/DevicePortal.htm), and application debugging and deployment.
