...
2.	Wi-Fi USB device capable of starting a SoftAP. Consult the [Hardware Compatibility List]({{site.baseurl}}/en-US/Docs/SupportedInterfaces.htm#WiFi-Dongles){:target="_blank"} for supported Wi-Fi USB devices for your platform.
