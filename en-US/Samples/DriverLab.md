...
Instructions on how to set up your development environment with Visual Studio 2015 and Windows Driver Kit (WDK) can be found [here](https://developer.microsoft.com/en-us/windows/hardware/windows-driver-kit)
