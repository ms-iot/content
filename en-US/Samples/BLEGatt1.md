...
permalink: /en-US/Samples/BLEGatt1.htm
lang: en-US
---
...
Remember this is a command line tool and [here]({{site.baseurl}}/{{page.lang}}/Samples/BLEGattDump.htm){:target="_blank"} is an example GATT attribute table dump file of the SensorTag.
