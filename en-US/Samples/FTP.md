...
layout: default
title: Using FTP
permalink: /en-US/Samples/FTP.htm
lang: en-US
---
...
* By default, the FTP server is running on your device.  In order to stop the FTP server on your device, you first need to connect to your device through [PowerShell]({{site.baseurl}}/{{page.lang}}/Samples/PowerShell.htm) or [SSH]({{site.baseurl}}/{{page.lang}}/Samples/SSH.htm).  
