...
3. Open the constantParam.cs file, you need to specify your own azure clientid and clientsecret
	...
	Note: this is an account which you need to access the MS translation service in azure;
	Follow this [link](http://www.microsoft.com/en-us/translator/getstarted.aspx) to get an account, 
	And	once you get it, replace the clientid and clientsecret with yours.
