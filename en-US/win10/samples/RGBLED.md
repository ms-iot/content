...
The pinout of the Tri-color LED is shown below and can be found in the [datasheet](http://www.kingbrightusa.com/Resources/images/catalog/SPEC/WP154A4SUREQBFZGC.pdf){:target="_blank"}.
