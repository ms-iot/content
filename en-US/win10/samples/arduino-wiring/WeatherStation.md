...
<ol>
    <li>Create a new project by following the <a href="{{site.baseurl}}/en-US/win10/ArduinoWiringProjectGuide.htm" target="_blank">wiring project setup guide</a>.</li>
...
Refer to the <a href="{{site.baseurl}}/en-US/win10/ArduinoWiringProjectGuide.htm">Arduino Wiring Project Guide</a> for more instructions on how to deploy your app!
</p>
<p>
