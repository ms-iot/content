...
1. Download the MockAdapter.zip file [here](https://github.com/ms-iot/samples/blob/develop/AllJoyn/AlljoynMockAdapter/MockAdapter.zip?raw=true) to a locaiton on your local machine
