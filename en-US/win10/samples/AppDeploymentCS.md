...
Otherwise, use the IP address of your Windows IoT Core device. After entering the device name/IP select `Universal (Unencrypted Protocol)` for Windows Authentication, then click **Select**.
